...
def _sample_normal() -> dict:
    return {
        ...
        "job": random.choices(
            ["admin.", "technician", "blue-collar", "services", "management"],
            weights=[25, 16, 22, 10, 7],
        )[0],
        ...
        "month": random.choices(["may", "jul", "aug", "jun", "nov"], weights=[33, 17, 15, 13, 10])[
            0
        ],
        "day_of_week": random.choices(
            ["mon", "tue", "wed", "thu", "fri"], weights=[20, 20, 20, 20, 20]
        )[0],
...
def _sample_mild() -> dict:
    ...
    return {
        ...
        "job": random.choices(
            ["admin.", "technician", "blue-collar", "retired", "services"],
...
def _sample_drifted() -> dict:
    ...
    return {
        ...
        "education": random.choices(
            ["basic.4y", "basic.6y", "basic.9y", "unknown"], weights=[40, 25, 25, 10]
        )[0],
